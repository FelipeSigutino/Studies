...
int[] sq_greenx = {40, 55, 63, 17, 22, 88, 4, 101, 57, 33, 117, 9, 78, 64, 42};
int[] sq_greeny = {40, 55, 63, 17, 22, 2, 29, 19, 7, 22, 10, 27, 16, 5, 21};
int[] sq_redx = {7, 82, 53, 110, 38, 24, 115, 68, 92, 12, 41, 85, 59, 29, 100};
int[] sq_redy = {12, 28, 6, 1, 14, 9, 24, 18, 3, 26, 11, 20, 15, 7, 30};
    ...
    for (i = 1; i <= 3; i++) {
        ...
        void planned_squares() {
            ...
            for(int i=0;i<=14;i++){
                ...
                setfgcolor(2);
                draw_square(sq_greenx[i],sq_greeny[i]);
                setfgcolor(9);
                draw_square(sq_redx[i],sq_redy[i]);
                delay(200);
                delete_square3x3(sq_bluex[i],sq_bluey[i]);
                delete_square3x3(sq_greenx[i],sq_greeny[i]);
                delete_square3x3(sq_redx[i],sq_redy[i]);
                if (i==14){
                    i=0;
                }
            }
