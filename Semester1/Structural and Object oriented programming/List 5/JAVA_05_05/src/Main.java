...
static Random rand = new Random(1000011);
...
public static void main() {
    ...
    TPlayer Player1 = createPlayer1(1);
    TPlayer Player2 = createPlayer2(2);
    ...
    while (!quit) {
        ...
        switch (Player1.CONTROL) {
                ...
                break;}
                case 1 -> {moveAI1(Player1, squares);
                break;}
                case 2 -> {moveAI2(Player2, squares);}
            }
        switch (Player2.CONTROL) {
            case 0 -> {for(int i =0 ; i <5 ; i++) {
                ...
                break;}
            case 1 -> {moveAI1(Player2, squares);
                break;}
            case 2 -> {moveAI2(Player2, squares);}
        }
